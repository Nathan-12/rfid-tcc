              ...
              <v-form>
                <v-card-text>
                  <v-card-actions class="layout column align-center">
                    <v-layout row>
                      <v-btn color="primary" large type="submit" to="/addAssociacao">Associação</v-btn>
                      <v-btn color="primary" large type="submit">Atividade2</v-btn>
                      <v-btn color="primary" large type="submit">Atividade3</v-btn>
                    </v-layout>
                  </v-card-actions>
                </v-card-text>
              </v-form>
