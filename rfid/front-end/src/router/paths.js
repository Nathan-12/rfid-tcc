...
import AddPage from '../views/inicio/Add'
import AddAssociacaoPage from '../views/inicio/AddAssociacao'
...
import DetalhesLocalProvaCoordenadorPage from '../views/coordenador/exame/DetalhesLocalProva'
// import DetalhesLocalProvaSecretarioPage from '../views/coordenador/exame/DetalhesLocalProva'
...
export default [
    ...
    {
        path: '/coordenador/exames', component: HomePage, redirect: { name: 'NotFound' },
        meta: { requiresAuth: true },
        children: [
            {
                path: '', name: 'CoordenadorExames', component: ListagemExamesPage,
                meta: { permissions: [{ role: "COORDENADOR", access: true }] }
            },

            {
                path: 'adicionar', component: CadastrarExamePage,
                meta: { permissions: [{ role: "COORDENADOR", access: true }] }
            },

            {
                path: ':id', name: 'CoordenadorLocalProva', component: DetalhesExameCoordenadorPage,
                meta: { permissions: [{ role: "COORDENADOR", access: true }] }
            },

            {
                path: ':exameId/candidato-inscrito/:id', props: true, component: DetalhesInscricaoPage,
                meta: { permissions: [{ role: "COORDENADOR", access: true }] }
            },
